...
- ✅ **Interactive demo live** → https://builtbycnob.github.io/netbank/design/demo/ — one clickable phone + 90s guided tour: three-truths reveal, Tax-Sweep+, Concurso Radar, per-Payer reliability + flywheel, nine-agent bridge to the human gate, honest don't-borrow ([`design/demo/`](design/demo/))
